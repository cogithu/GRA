...
def get_config():
    ...
    Prepare parameters:
        --algorithm_name <algorithm_name>
            specifiy the algorithm, including `["gra", "mappo"]`
        --experiment_name <str>
    ...
    # prepare parameters
    parser.add_argument("--algorithm_name", type=str, default="gra", choices=["gra", "mappo"])
    ...
    # optimizer parameters
    parser.add_argument("--lr", type=float, default=8e-5, help="learning rate (default: 5e-4)")
    parser.add_argument(
        "--critic_lr",
        type=float,
        default=8e-5,
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        default="../results/MyEnv/encircle/models",
    ...
    parser.add_argument('--num_embeddings', type=int, default=9,
                        help="Number of entity types in the env to have "
                             "different embeddings for each entity type")
    parser.add_argument('--embedding_size', type=int, default=8, #8
                        help="Embedding layer output size for each category")
    parser.add_argument('--embed_hidden_size', type=int, default=16, #16
    ...
    parser.add_argument('--gnn_hidden_size', type=int, default=16, #16
    ...
    parser.add_argument('--rgnn_layer_N', type=int, default=1,
                        help="Number of reward GNN conv layers")
    parser.add_argument('--obsgnn_layer_N', type=int, default=1,
                        help="Number of observation GNN conv layers")
