...
from algorithms.offpolicy.utils.mlp_buffer import MlpReplayBuffer, PrioritizedMlpReplayBuffer
from algorithms.offpolicy.utils.util import is_discrete, is_multidiscrete, DecayThenFlatSchedule
...
class MlpRunner(object):
    ...
    def __init__(self, config):
        ...
        self.env_name = self.args.environment_name
        ...
        self.eval_env = config["eval_envs"]
        ...
        if self.algorithm_name == "maddpg":
            from algorithms.offpolicy.maddpg.algorithm.MADDPGPolicy import MADDPGPolicy as Policy
            from algorithms.offpolicy.maddpg.maddpg import MADDPG as TrainAlgo
        ...
        #     from offpolicy.algorithms.masac.masac import MASAC as TrainAlgo
            ...
            from algorithms.offpolicy.mqmix.algorithm.mQMixPolicy import M_QMixPolicy as Policy
            from algorithms.offpolicy.mqmix.mqmix import M_QMix as TrainAlgo
