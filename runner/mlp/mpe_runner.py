...
import time
import pickle
from algorithms.offpolicy.utils.util import is_multidiscrete
from runner.mlp.base_runner import MlpRunner
import matplotlib
matplotlib.use('Agg')
...
class MPERunner(MlpRunner):
    ...
    def eval(self):
        ...
        plt.savefig(self.save_dir + '/pltnew18.png', format='png')
        plt.close("all")
