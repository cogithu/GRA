...
from algorithms.offpolicy.utils.util import init, to_torch
from algorithms.offpolicy.utils.mlp import MLPBase
from algorithms.offpolicy.utils.act import ACTLayer
...
class MADDPG_Critic(nn.Module):
    ...
    def forward(self, central_obs, central_act):
        ...
        # print(f"FC Layer Device: {self.q_outs[].weight.device}")
        x = self.mlp(x)
