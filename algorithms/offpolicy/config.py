...
def get_config():
    ...
    # prepare parameters
    parser.add_argument("--algorithm_name", type=str, default="mqmix", choices=[
    ...
    # env parameters
    # parser.add_argument('--env_name', type=str, default="resource_allocation")
    parser.add_argument("--environment_name", type=str, default="mpe",  #resource_allocation
